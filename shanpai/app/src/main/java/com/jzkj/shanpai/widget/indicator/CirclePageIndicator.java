...
import sp.base.utils.DimenUtil;
...
public class CirclePageIndicator extends View implements PageIndicator {
    ...
    protected float mExtraOffset = 30;
    ...
    public CirclePageIndicator(Context context, AttributeSet attrs) {
        ...
        final float defaultStrokeWidth = DimenUtil.dip2px(1);
        final float defaultRadius = DimenUtil.dip2px(3);
     ...
     * @param offset in dp
     */
    public void setExtraOffset(float offset) {
        mExtraOffset = getContext().getResources().getDisplayMetrics().density * offset;
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        final float threeRadius = mRadius * 3 + mExtraOffset;
    ...
    private int measureLong(int measureSpec) {
        ...
        if ((specMode == MeasureSpec.EXACTLY) || (mViewPager == null)) {
            ...
            result = (int) (getPaddingLeft() + getPaddingRight()
                    + (count * 2 * mRadius) + (count - 1) * mRadius + (count - 1) * mExtraOffset + 1);
