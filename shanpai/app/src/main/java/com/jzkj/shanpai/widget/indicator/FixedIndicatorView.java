...
public class FixedIndicatorView extends LinearLayout implements Indicator {
    ...
    public void setCurrentItemAndData(int item, boolean anim) {
        setCurrentItem(item, anim);
        onItemSelectedListener.onItemSelected(null, item, 0);
    ...
    private void drawSlideBar(Canvas canvas) {
        ...
        int scrollBarWidth = scrollBar.getSlideView().getWidth()- scrollBarPadding;
    ...
    public void setScrollBarPadding(int scrollBarPadding) {
